...
namespace CleanCode.StudentDataSetTableAdapters {
...
SELECT Id, FirstName, LastName, UserName, UserPassword, UserRole, UserLogo, AddedDate FROM UserTable WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Id, FirstName, LastName, UserName, UserPassword, UserRole, UserLogo, Added" +
                "Date FROM dbo.UserTable";
        ...
        public virtual int FillBy(StudentDataSet.UserTableDataTable dataTable) {
